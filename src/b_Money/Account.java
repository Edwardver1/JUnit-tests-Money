...
public class Account {
	 ...
	 * 
	 * @param id
	 *            Id of timed payment to check for
	 */
	...
	public void tick() {
		for (TimedPayment tp : timedpayments.values()) {
			tp.tick();
			// !!! Commented tp.tick() | cause there were 2 of them !!!;
			// tp.tick();
		}
	}
		...
		public Boolean tick() {
			if (next == 0) {
				...
				try {
					...
					/*
					 * Revert transfer. In reality, this should probably cause a
